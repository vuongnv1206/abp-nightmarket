...
using NightMarket.Configurations.ProductAttributes;
using NightMarket.Configurations.Inventories;
using NightMarket.Configurations.InventoryTickets;
using NightMarket.Configurations.Manufacturers;
using NightMarket.Configurations.Orders;
...
public class NightMarketDbContext :
    AbpDbContext<NightMarketDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(NightMarketConsts.DbTablePrefix + "YourEntities", NightMarketConsts.DbSchema);
