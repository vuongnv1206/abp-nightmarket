...
namespace NightMarket.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        {
            var adminWebClientRootUrl = configurationSection["NightMarket_Admin:RootUrl"].TrimEnd('/');
        ...
        {
            var webClientRootUrl = configurationSection["NightMarket_Web:RootUrl"].EnsureEndsWith('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["NightMarket_Admin_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["NightMarket_Admin_Swagger:RootUrl"].TrimEnd('/');
            await CreateApplicationAsync(
